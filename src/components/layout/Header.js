    ...
    <>
      <div className="bg-red-900 sm:px-24 px-10 flex justify-between h-20 items-center text-lg">
        ...
        <div className="bg-red-950 px-4 py-2 rounded-2xl text-white flex items-center">
          ...
          <div className="px-3 hover:underline hover:cursor-pointer">
            Your Cart
          </div>
      ...
      <div className="relative">
        <img src={mealsImage} className="h-[40vh] w-[100vw] absolute" />

        <div className="absolute w-[100%] top-40">
          <div className="flex justify-center">
            <div className="bg-gray-600 w-[600px] p-4 rounded-lg shadow-gray-800 shadow-md">
